...
<body>
    ...
    <div class="simple-slider">
        <div class="swiper-container">
            ...
            <div class="swiper-button-prev" style="color: #212529"></div>
            <div class="swiper-button-next" style="color: #212529"></div>
        </div>
    </div>
        ...
        <div class="container py-4 py-lg-5">
            <ul class="list-inline">
                <li class="list-inline-item me-4">
                    <a href="https://www.facebook.com/lablob.sabbah/" target="_blank">
                ...
                <li class="list-inline-item me-4">
                    <a href="https://twitter.com/TdcLabeebsabbah" target="_blank">
                ...
                <li class="list-inline-item me-4">
                    <a href="https://www.instagram.com/king_of_mk0010/" target="_blank">
                ...
                <li class="list-inline-item me-4">
                    <a href="https://github.com/labeebSabbah" target="_blank">
                ...
                <li class="list-inline-item">
                    <a href="https://www.linkedin.com/in/labeeb-sabbah-024456220/" target="_blank">
            ...
            <p class="text-muted mb-0">Copyright © 2022 Labeeb Sabbah</p>
        </div>
    </footer>
